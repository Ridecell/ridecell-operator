...
func Add(mgr manager.Manager) error {
	_, err := components.NewReconciler("alertmanagerconfig-controller", mgr, &monitoringv1beta1.AlertManagerConfig{}, nil, []components.Component{
		amccomponents.NewAlertManagerConfig(),
	})
	return err
}
