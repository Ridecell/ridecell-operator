  ...
  template:
    ...
    spec:
      ...
      - name: default
        ...
        {{- else }}
        - {{ if (not .Instance.Spec.NoCore1540Fixup) }}if [ -f common/management/commands/core_1540_pre_migrate.py ]; then python manage.py core_1540_pre_migrate; fi && {{ end }}python manage.py migrate -v3
        {{- end }}
        resources:
          requests:
            memory: 1.5G
